...
class canvasPaths extends Component {
 ...
 this.drawCircle(context, this.state.cordinates.x, this.state.cordinates.y) */
  ...
  drawEverything() {
    ...
    context.fillRect(this.state.cordinates.x - this.state.ballX,this.state.cordinates.y - this.state.ballY,10,10);
    // context.clearRect(ballX - 50, 100,10,10);
  }

  change(ballX, ballY, movementValueX, movementValueY) {
    /*    this.setState({
        ...this.state,
      ballX: ballX + 50
  ...
  calcMove(ballX, ballY) {

    var movementValueX = this.state.cordinates.x - this.state.cordinates.a;
    var movementValueY = this.state.cordinates.y - this.state.cordinates.b;

    this.change(ballX, ballY, movementValueX, movementValueY);
